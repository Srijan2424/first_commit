...
export function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <Link className="brand" to="/" aria-label="MedPal home">
      <span className={compact ? 'brand-name compact' : 'brand-name'}>MedPal</span>
...
export function Topline() {
  return (
    <header className="topline">
      <Brand />
      <div className="topline-poem">People.<br />Medicines.<br />Brighter tomorrows.</div>
      ...
      <div className="topline-note">A more human practice,<br />powered by better tools.</div>
    </header>
  )
}
