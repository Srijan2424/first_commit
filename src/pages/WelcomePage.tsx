      ...
      <main className="welcome-grid">
        <section className="welcome-copy">
          ...
          <p className="display-subtitle">
            Prescriptions that keep their history.
          </p>
          <Orbit />
        </section>
        <section className="role-column" aria-label="Choose your role">
          ...
          >
            <span className="role-icon mint">
              <Stethoscope />
            </span>
            <span>
              <strong>I’m a doctor</strong>
              <small>Create and issue clear digital prescriptions.</small>
            </span>
            <span className="role-check">
              {role === "doctor" ? "Selected" : "Choose"}
            </span>
          </button>
          <button
          ...
          >
            <span className="role-icon bone">
              <UserRound />
            </span>
            <span>
              <strong>I’m a patient</strong>
              <small>Understand your medicines and what changed.</small>
            </span>
            <span className="role-check">
              {role === "patient" ? "Selected" : "Choose"}
            </span>
          </button>
          <div className="role-benefit">
            <FileText size={20} />
            <span>
              <strong>One record, clearer decisions.</strong>
              <small>Your history stays connected across consultations.</small>
            </span>
          </div>
          <button
            className="button primary wide"
            onClick={() => navigate(`/sign-in?role=${role}`)}
          >
            Continue as {role}
            <ArrowRight />
          </button>
